...
function renderizar_questoes(questions) {
	for (var index = 0; index < 20; ++index) {
		try {
			questoes_recentes.innerHTML += '<li class="list-group-item bg-main questao" style="border: none" data-id="'+questions[index].id+'">' +
																		'<div class="card-body" style="border: none">' +
                                                                            ...
                                                                            '<small class="text-muted">' +
                                                                                (questions[index].total_answers == 1 ? '<span id="response-counter-'+questions[index].id+'">1</span> <span id="response-sentence-'+questions[index].id+'">resposta</span>' : '<span id="response-counter-'+questions[index].id+'">'+questions[index].total_answers+'</span> <span id="response-sentence-'+questions[index].id+'">respostas</span>') + ' | ' + questions[index].pub_date +
                                                                            '</small>' +
																			'<hr>' +
...
function renderizar_questoes_populares(popular_questions) {
    ...
    try { questoes_populares.innerHTML += '<li class="list-group-item bg-main questao" data-id="'+popular_questions[index].id+'">' +
                                                                    '<div class="card-body">' +
                                                                        ...
                                                                        '<small class="text-muted">' +
                                                                                (popular_questions[index].total_answers == 1 ? '<span id="response-counter-'+popular_questions[index].id+'">1</span> <span id="response-sentence-'+popular_questions[index].id+'">resposta</span>' : '<span id="response-counter-'+popular_questions[index].id+'">'+popular_questions[index].total_answers+'</span> <span id="response-sentence-'+popular_questions[index].id+'">respostas</span>') + ' | ' + popular_questions[index].pub_date +
                                                                            '</small>' +
                                                                        '<hr>' +
